...
const MyAppointments = () => {
  ...
  // const getUserAppointmetns = async () =>  {
  //   try {
  ...
  const initPay = (order) => {
    const options = {
      ...
      handler: async (response) => {
        ...
        try {
          const {data} = await axios.post(backendUrl + '/api/user/verifyRazropay', response, {headers: {token}})
          if(data.success) {
            getUserAppointmetns()
  ...
  const appointmentRazorpay = async (appointmentId) => {
    try {
      ...
      // Log the error response if it exists, otherwise log the error message
